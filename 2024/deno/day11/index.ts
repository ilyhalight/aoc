...
const memoryCalc = new Map<number, number | number[]>();
const memoryBlink = new Map<string, number>();
memoryCalc.set(0, 1);

const calc = (value: number): number | number[] => {
...
const blink = (value: number, count: number) => {
